...
function getMealTime(){
    ...
    return tod > 20 ? 'late-night snacks' : tod > 16 ? 'dinner' : tod > 11 ? 'lunch' : 'breakfast'
}
...
function buildAd2(coordinates){
    ...
    let inner = document.createElement('p')
    inner.innerHTML = `It's time to try out coffee! <span><a href="${href}" target="_blank">We're this close!</a></span>`
    content.append(inner)
}
